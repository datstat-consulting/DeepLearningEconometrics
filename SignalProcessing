...
class KalmanNet:
    def __init__(self, layer_sizes_f, layer_sizes_h, activation_function, optimizer_function):
        self.layer_sizes_f = layer_sizes_f
        self.layer_sizes_h = layer_sizes_h
        self.activation_function = activation_function
        self.optimizer_function = optimizer_function
        # state transition model
        self.model_f = PerceptronMain(self.layer_sizes_f, self.activation_function, self.optimizer_function, add_bias=False)
        # observation model
        self.model_h = PerceptronMain(self.layer_sizes_h, self.activation_function, self.optimizer_function, add_bias=False)
    ...
    def update_state(self, next_state_pred, observation):
        """
